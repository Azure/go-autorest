...
// Defines a type similar to time.Time but assumes a layout of RFC3339 date-time (i.e., 2006-01-02T15:04:05Z).
...
// Preserves the DateTime as a byte array conforming to RFC3339 date-time (i.e., 2006-01-02T15:04:05Z).
func (d DateTime) MarshalBinary() ([]byte, error) {
	return d.Time.MarshalText()
}

// Reconstitutes a DateTime saved as a byte array conforming to RFC3339 date-time (i.e., 2006-01-02T15:04:05Z).
func (d *DateTime) UnmarshalBinary(data []byte) error {
	return d.Time.UnmarshalText(data)
}

// Preserves the DateTime as a JSON string conforming to RFC3339 date-time (i.e., 2006-01-02T15:04:05Z).
func (d DateTime) MarshalJSON() (json []byte, err error) {
	return d.Time.MarshalJSON()
}

// Reconstitutes the DateTime from a JSON string conforming to RFC3339 date-time (i.e., 2006-01-02T15:04:05Z).
